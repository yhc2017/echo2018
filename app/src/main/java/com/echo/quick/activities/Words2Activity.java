...
//        // 监听拖拽和侧滑删除，更新UI和数据源。
////        rvList.setOnItemMoveListener(getItemMoveListener());
//        // 监听Item的手指状态，拖拽、侧滑、松开。
//        rvList.setOnItemStateChangedListener(mOnItemStateChangedListener);
//
//        mWordsAdapter = new WordsAdapter(this);
//        rvList.setAdapter(mWordsAdapter);
//        mWordsAdapter.notifyDataSetChanged(getData());
////        initView();
//    }
//    /**
//     * Method name : getData()
//     * Specific description :测试的假数据
//     *@return mData ArrayList<String>
//     */
...
//
//    /**
//     * Method name : getItemMoveListener(）
//     * Specific description :监听侧滑删除，更新UI和数据源。
//     *@param
//     *@param
//     *@return
//     */
